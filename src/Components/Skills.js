            ...
            <div style={{display: "flex", justifyContent: "center"}}>
                <div style={{backgroundColor: "#3e50b5", width: width > 1100 ? "1000px" : width > 900 ? "800px" : width > 600 ? "500px" : width > 450 ? "400px" : "350px", borderRadius: "30px", paddingTop: "40px", paddingBottom: "40px"}}>
                    <div style={{display: "flex", justifyContent: "center", alignItems: "center", flexDirection: "column"}}>
                        <p style={{fontFamily: "Nunito", fontWeight: width > 600 ? "bold" : "", fontSize: "1.6rem", color: "white", margin: "0"}}>Languages</p>
                        <div style={{display: "flex", justifyContent: "center", flexDirection: "column"}}>
                            <div style={{marginTop: "20px", display: "flex", flexDirection: "row"}}>
                                <div style={{marginLeft: "5px", marginRight: "5px", width: width > 600 ? "100px" : "70px", height: "50px", borderRadius: "20px", backgroundColor: "#FDE618", display: "flex", justifyContent: "center", alignItems: "center"}}>
                                    <p style={{fontFamily: "Nunito", fontSize: width > 600 ? "1rem" : "0.8rem", fontWeight: width > 600 ? "bold" : ""}}>TypeScript</p>
                                </div>
                                <div style={{marginLeft: "5px", marginRight: "5px", width: width > 600 ? "100px" : "70px", height: "50px", borderRadius: "20px", backgroundColor: "#FDE618", display: "flex", justifyContent: "center", alignItems: "center"}}>
                                    <p style={{fontFamily: "Nunito", fontSize: width > 600 ? "1rem" : "0.8rem", fontWeight: width > 600 ? "bold" : ""}}>JavaScript</p>
                                </div>
                                <div style={{marginLeft: "5px", marginRight: "5px", width: width > 600 ? "100px" : "70px", height: "50px", borderRadius: "20px", backgroundColor: "#FDE618", display: "flex", justifyContent: "center", alignItems: "center"}}>
                                    <p style={{fontFamily: "Nunito", fontSize: width > 600 ? "1rem" : "0.8rem", fontWeight: width > 600 ? "bold" : ""}}>HTML</p>
                                </div>
                                <div style={{marginLeft: "5px", marginRight: "5px", width: width > 600 ? "100px" : "70px", height: "50px", borderRadius: "20px", backgroundColor: "#FDE618", display: "flex", justifyContent: "center", alignItems: "center"}}>
                                    <p style={{fontFamily: "Nunito", fontSize: width > 600 ? "1rem" : "0.8rem", fontWeight: width > 600 ? "bold" : ""}}>CSS</p>
                                </div>
                            </div>
                            <div style={{marginTop: "20px", display: "flex", justifyContent: "center", flexDirection: "row"}}>
                                <div style={{marginLeft: "5px", marginRight: "5px", width: width > 600 ? "100px" : "70px", height: "50px", borderRadius: "20px", backgroundColor: "#FDE618", display: "flex", justifyContent: "center", alignItems: "center"}}>
                                    <p style={{fontFamily: "Nunito", fontSize: width > 600 ? "1rem" : "0.8rem", fontWeight: width > 600 ? "bold" : ""}}>C</p>
                                </div>
                                <div style={{marginLeft: "5px", marginRight: "5px", width: width > 600 ? "100px" : "70px", height: "50px", borderRadius: "20px", backgroundColor: "#FDE618", display: "flex", justifyContent: "center", alignItems: "center"}}>
                                    <p style={{fontFamily: "Nunito", fontSize: width > 600 ? "1rem" : "0.8rem", fontWeight: width > 600 ? "bold" : ""}}>Java</p>
                                </div>
                                <div style={{marginLeft: "5px", marginRight: "5px", width: width > 600 ? "100px" : "70px", height: "50px", borderRadius: "20px", backgroundColor: "#FDE618", display: "flex", justifyContent: "center", alignItems: "center"}}>
                                    <p style={{fontFamily: "Nunito", fontSize: width > 600 ? "1rem" : "0.8rem", fontWeight: width > 600 ? "bold" : ""}}>Python</p>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div style={{display: "flex", justifyContent: "center", alignItems: "center", flexDirection: "column"}}>
                        <p style={{fontFamily: "Nunito", fontWeight: width > 600 ? "bold" : "", fontSize: "1.6rem", color: "white", margin: "0", marginTop: "40px"}}>Skills</p>
                        <div style={{display: "flex", justifyContent: "center", flexDirection: "column"}}>
                            <div style={{marginTop: "20px", display: "flex", flexDirection: "row"}}>
                                <div style={{marginLeft: "5px", marginRight: "5px", width: width > 600 ? "100px" : "70px", height: "50px", borderRadius: "20px", backgroundColor: "#FDE618", display: "flex", justifyContent: "center", alignItems: "center"}}>
                                    <p style={{fontFamily: "Nunito", fontSize: width > 600 ? "1rem" : "0.8rem", fontWeight: width > 600 ? "bold" : ""}}>React</p>
                                </div>
                                <div style={{marginLeft: "5px", marginRight: "5px", width: width > 600 ? "100px" : "70px", height: "50px", borderRadius: "20px", backgroundColor: "#FDE618", display: "flex", justifyContent: "center", alignItems: "center"}}>
                                    <p style={{fontFamily: "Nunito", fontSize: width > 600 ? "1rem" : "0.8rem", fontWeight: width > 600 ? "bold" : ""}}>Gatsby</p>
                                </div>
                                <div style={{marginLeft: "5px", marginRight: "5px", width: width > 600 ? "100px" : "70px", height: "50px", borderRadius: "20px", backgroundColor: "#FDE618", display: "flex", justifyContent: "center", alignItems: "center"}}>
                                    <p style={{fontFamily: "Nunito", fontSize: width > 600 ? "1rem" : "0.8rem", fontWeight: width > 600 ? "bold" : ""}}>NextJS</p>
                                </div>
                                <div style={{marginLeft: "5px", marginRight: "5px", width: width > 600 ? "100px" : "70px", height: "50px", borderRadius: "20px", backgroundColor: "#FDE618", display: "flex", justifyContent: "center", alignItems: "center"}}>
                                    <p style={{fontFamily: "Nunito", fontSize: width > 600 ? "1rem" : "0.8rem", fontWeight: width > 600 ? "bold" : ""}}>GraphQL</p>
                                </div>
                            </div>
                            <div style={{marginTop: "20px", display: "flex", flexDirection: "row"}}>
                                <div style={{marginLeft: "5px", marginRight: "5px", width: width > 600 ? "100px" : "70px", height: "50px", borderRadius: "20px", backgroundColor: "#FDE618", display: "flex", justifyContent: "center", alignItems: "center"}}>
                                    <p style={{fontFamily: "Nunito", fontSize: width > 600 ? "1rem" : "0.8rem", fontWeight: width > 600 ? "bold" : ""}}>Node</p>
                                </div>
                                <div style={{marginLeft: "5px", marginRight: "5px", width: width > 600 ? "100px" : "70px", height: "50px", borderRadius: "20px", backgroundColor: "#FDE618", display: "flex", justifyContent: "center", alignItems: "center"}}>
                                    <p style={{fontFamily: "Nunito", fontSize: width > 600 ? "1rem" : "0.8rem", fontWeight: width > 600 ? "bold" : ""}}>Express</p>
                                </div>
                                <div style={{marginLeft: "5px", marginRight: "5px", width: width > 600 ? "100px" : "70px", height: "50px", borderRadius: "20px", backgroundColor: "#FDE618", display: "flex", justifyContent: "center", alignItems: "center"}}>
                                    <p style={{fontFamily: "Nunito", fontSize: width > 600 ? "1rem" : "0.8rem", fontWeight: width > 600 ? "bold" : ""}}>MySQL</p>
                                </div>
                                <div style={{marginLeft: "5px", marginRight: "5px", width: width > 600 ? "100px" : "70px", height: "50px", borderRadius: "20px", backgroundColor: "#FDE618", display: "flex", justifyContent: "center", alignItems: "center"}}>
                                    <p style={{fontFamily: "Nunito", fontSize: width > 600 ? "1rem" : "0.8rem", fontWeight: width > 600 ? "bold" : ""}}>Mongo</p>
                                </div>
                            </div>
                            <div style={{marginTop: "20px", display: "flex", flexDirection: "row"}}>
                                <div style={{marginLeft: "5px", marginRight: "5px", width: width > 600 ? "100px" : "70px", height: "50px", borderRadius: "20px", backgroundColor: "#FDE618", display: "flex", justifyContent: "center", alignItems: "center"}}>
                                    <p style={{fontFamily: "Nunito", fontSize: width > 600 ? "1rem" : "0.8rem", fontWeight: width > 600 ? "bold" : ""}}>Firebase</p>
                                </div>
                                <div style={{marginLeft: "5px", marginRight: "5px", width: width > 600 ? "100px" : "70px", height: "50px", borderRadius: "20px", backgroundColor: "#FDE618", display: "flex", justifyContent: "center", alignItems: "center"}}>
                                    <p style={{fontFamily: "Nunito", fontSize: width > 600 ? "1rem" : "0.8rem", fontWeight: width > 600 ? "bold" : ""}}>Git</p>
                                </div>
                                <div style={{marginLeft: "5px", marginRight: "5px", width: width > 600 ? "100px" : "70px", height: "50px", borderRadius: "20px", backgroundColor: "#FDE618", display: "flex", justifyContent: "center", alignItems: "center"}}>
                                    <p style={{fontFamily: "Nunito", fontSize: width > 600 ? "1rem" : "0.8rem", fontWeight: width > 600 ? "bold" : ""}}>Heroku</p>
                                </div>
                                <div style={{marginLeft: "5px", marginRight: "5px", width: width > 600 ? "100px" : "70px", height: "50px", borderRadius: "20px", backgroundColor: "#FDE618", display: "flex", justifyContent: "center", alignItems: "center"}}>
                                    <p style={{fontFamily: "Nunito", fontSize: width > 600 ? "1rem" : "0.8rem", fontWeight: width > 600 ? "bold" : ""}}>Netlify</p>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div style={{display: "flex", justifyContent: "center", alignItems: "center", flexDirection: "column"}}>
                        <p style={{fontFamily: "Nunito", fontWeight: width > 600 ? "bold" : "", fontSize: "1.6rem", color: "white", margin: "0", marginTop: "40px"}}>Languages</p>
                        <div style={{display: "flex", justifyContent: "center", flexDirection: "column"}}>
                            <div style={{marginTop: "20px", display: "flex", flexDirection: "row"}}>
                                <div style={{marginLeft: "5px", marginRight: "5px", width: width > 600 ? "100px" : "70px", height: "50px", borderRadius: "20px", backgroundColor: "#FDE618", display: "flex", justifyContent: "center", alignItems: "center"}}>
                                    <p style={{fontFamily: "Nunito", fontSize: width > 600 ? "1rem" : "0.8rem", fontWeight: width > 600 ? "bold" : ""}}>Figma</p>
                                </div>
                                <div style={{marginLeft: "5px", marginRight: "5px", width: width > 600 ? "100px" : "70px", height: "50px", borderRadius: "20px", backgroundColor: "#FDE618", display: "flex", justifyContent: "center", alignItems: "center"}}>
                                    <p style={{fontFamily: "Nunito", fontSize: width > 600 ? "1rem" : "0.8rem", fontWeight: width > 600 ? "bold" : ""}}>Gimp</p>
                                </div>
                            </div>
                        </div>
                    </div>
