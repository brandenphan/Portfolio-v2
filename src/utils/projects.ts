export const projects = [
  { name: "Recapify", desc: "Google Chrome extension that allows users to quickly summarize highlighted text.", link: "https://github.com/L-Michael1/Recapify", languages: ["JavaScript", "Python", "HTML", "CSS"] },
