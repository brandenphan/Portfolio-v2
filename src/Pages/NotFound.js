...
const NotFound = () => {
    ...
    return (
        <div style={{height: "95vh", display: "flex", flexDirection: "column", justifyContent: "center", alignItems: "center", paddingLeft: "20px", paddingRight: "20px"}}>
            ...
            <Button component={Link} to="/" variant="outlined" sx={{fontFamily: "Montserrat", fontWeight: "bold", marginTop: "30px", color: "black", border: "1px solid black", "&:hover": {backgroundColor: "#C9C9C9", border: "1px solid black"}}}>Back to Home</Button>
        </div>
    );
};
